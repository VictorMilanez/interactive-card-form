...
export const Card = ({ receivedValue }: CardProps) => {
  return (
    <>
      <div className="lg:w-90 md:w-84 md:h-54 sm:h-44 w-82 h-44 p-4 flex flex-col justify-end rounded-xl bg-[url('/images/bg-card-front.png')] absolute sm:top-24 sm:left-36 md:top-36 md:left-1/2 lg:top-35 lg:left-30 top-24 z-1">
        ...
        <p className="ml-4 text-white sm:text-2xl text-xl font-semibold tracking-widest">
      ...
      <div className="lg:w-90 md:w-84 md:h-54 sm:w-84 sm:h-44 w-82 h-44 flex justify-end items-center rounded-xl bg-[url('/images/bg-card-back.png')] absolute left-12 top-2 sm:top-2 sm:left-48 md:top-4 md:left-2/3 lg:top-95 lg:left-45 z-0">
        <p className="md:pt-6 sm:pt-14 pt-16 pr-4 tracking-widest text-white text-xs">
